      ...
      stats.innerHTML = `
        <div class="stat-card stat-green">
          ...
          <div class="stat-info">
            ...
            <div class="stat-sub">Dashboard automático desativado para teste</div>
          </div>
        </div>
      `;
    }
...
import { getUserProfile, canEdit, isAdmin } from "./permissions.js";
...
async function loadPermissions() {
  ...
  // esconder botão excluir se não for admin
  if (!isAdmin(role)) {
  ...
  // esconder botão editar se for viewer
  if (!canEdit(role)) {
